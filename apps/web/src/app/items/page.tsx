          ...
          <div className="card-enterprise" style={{ width: '480px', maxWidth: '90%' }}>
            ...
            <form onSubmit={handleSaveItem}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '16px' }}>
                <div>
                  <label style={{ display: 'block', fontSize: '0.78rem', fontWeight: 600, color: '#475569', marginBottom: '4px' }}>Unit Selling Price (AED)</label>
                  <input
                    type="number"
                    step="0.01"
                    value={newItemPrice}
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '0.78rem', fontWeight: 600, color: '#475569', marginBottom: '4px' }}>Initial Stock On Hand</label>
                  <input
                    type="number"
                    value={newItemStock}
